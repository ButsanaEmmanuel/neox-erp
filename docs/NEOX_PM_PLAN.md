...
**Statut : 🔄 En cours — Tâche 7.1 fermée (1/7)**
...
### Tâche 7.2 — D12 CHECK completionPct (à venir)
### Tâche 7.3 — D9 Zod-style validation `/details` (à venir, inline manuel)
### Tâche 7.4 — D3 ProjectScope.constraints harden (à venir)
### Tâche 7.5 — D11 bookmark `?view=pending-qa` (à venir)
