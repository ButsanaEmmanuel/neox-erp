// ISO-3166-1 alpha-3 country list. Stored value is the alpha-3 code
// (e.g. "COD" for Democratic Republic of the Congo). The label is the
// human-readable English name shown in dropdowns. Keep alphabetised by
// label so the <select> reads naturally without runtime sort cost.
